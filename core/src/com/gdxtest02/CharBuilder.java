...
public class CharBuilder {
	...
	public static Char build(int name) {
		Char c = null;
		switch (name) {
		case CHAR_01: c = new TestChar01("c1");break;
		case CHAR_02: c = new TestChar02("c2");break;
		case CHAR_03: c = new TestChar03("c3");break;
		case CHAR_04: c = new TestChar04("c4");break;
		case CHAR_05: c = new TestChar05("c5");break;
		case CHAR_06: c = new TestChar06("c6");break;
		case CHAR_07: c = new TestChar07("c7");break;
		case CHAR_08: c = new TestChar08("c8");break;
