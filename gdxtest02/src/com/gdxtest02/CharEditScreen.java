...
public class CharEditScreen implements Screen {

	protected GdxTest02 game;

	private OrthographicCamera camera;

	protected CharEditScreenUI ui;
	
	private Array<Char> charSequence;
	private String level_name;

	public CharEditScreen(GdxTest02 game, Char player) {
		this.game = game;
		charSequence = new Array<Char>();
		
		camera = new OrthographicCamera();
		camera.setToOrtho(false, game.VIRTUAL_WIDTH, game.VIRTUAL_HEIGHT);
		ui = new CharEditScreenUI();
		ui.setupUi(this, player);
